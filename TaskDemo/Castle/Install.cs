...
namespace TaskDemo
{
    public static class Install
    {
        ...
        public static IWindsorInstaller Service<TService, TImplementation>(Action<ComponentRegistration<TService>> registration = null) where TService : class where TImplementation : class, TService
        {
